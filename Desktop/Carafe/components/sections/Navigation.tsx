      ...
      >
        <div className="w-full mx-auto px-6 md:px-12 lg:px-20 flex items-center justify-between" style={{ maxWidth: 1240 }}>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <a
              href="https://carafe-app-prod.netlify.app/login"
        ...
        {menuOpen && (
          ...
          >
            ...
            <div className="mt-12 flex flex-col gap-4">
              <a href="https://carafe-app-prod.netlify.app/login" className="text-base" style={{ color: "var(--foreground-muted)" }}>Se connecter →</a>
              <a
                href="#cta"
                onClick={() => setMenuOpen(false)}
