...
const problems = [
  {
    icon: Waves,
    title: "Tout se noie dans le flux",
    desc: "Le nouveau qui arrive ? Aucune visibilité. Les anciens ? Ils ne lisent plus.",
  },
  {
    icon: BellOff,
    title: "Messages à toute heure",
    desc: "Le manager qui poste à 2h du mat. Le droit à la déconnexion, où ça ?",
  },
  {
    icon: FileX,
    title: "Protocoles sur papier",
    desc: "Distribués à la va-vite. À la poubelle deux jours après. Et personne ne sait qui a lu quoi.",
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center mb-14">
          ...
          >
            <p className="text-lg leading-relaxed mb-6" style={{ color: "var(--foreground-muted)" }}>
              47 membres. 200 messages par jour. Des infos critiques noyées entre les GIFs et les retards de train.
              Vos protocoles envoyés à 23h. Vos employés qui coupent les notifications.
            </p>
            <p className="text-base leading-relaxed" style={{ color: "var(--foreground-dim)" }}>
              C&apos;est pas de la mauvaise volonté. C&apos;est juste le mauvais outil.
            </p>
          </motion.div>
        </div>
