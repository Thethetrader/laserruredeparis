    ...
    <div style={{ display: "block" }}>
      ...
      <div style={{ marginBottom: 8 }}>
        {needs.map(({ service, staff }) => (
          <div
            key={service}
            style={{ display: "block", marginBottom: 6, padding: "8px 12px", borderRadius: 8, background: "var(--background-elev)", border: "1px solid var(--border)" }}
          >
      ...
      {/* Bouton → génération → planning */}
      <div style={{ display: "block", position: "relative" }}>
        {/* Bouton & génération */}
        <motion.div
          animate={{ opacity: phase === "done" ? 0 : 1, y: phase === "done" ? -4 : 0 }}
          transition={{ duration: 0.2 }}
          style={{ display: "block", pointerEvents: phase === "done" ? "none" : "auto" }}
        >
          <div
            style={{
              display: "block",
              ...
              background: phase === "generating" ? "rgba(6,182,212,0.1)" : "rgba(6,182,212,0.05)",
              fontSize: 11,
              fontWeight: 600,
              color: "var(--accent)",
              textAlign: "left",
        ...
        <motion.div
          ...
          style={{ display: "block", position: phase === "done" ? "static" : "absolute", top: 0, left: 0, right: 0 }}
        >
          <div style={{ display: "block", marginBottom: 6, padding: "6px 12px", borderRadius: 8, background: "rgba(16,185,129,0.07)", border: "1px solid rgba(16,185,129,0.2)" }}>
