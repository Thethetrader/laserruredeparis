...
function ProtocolCard({ protocol, isManager, isExpanded, isRead, onToggle, onMarkRead }: ProtocolCardProps) {
  ...
  return (
    <div className="rounded-xl overflow-hidden"
      ...
      <button onClick={onToggle} className="w-full text-left px-5 py-4 flex items-start gap-3">
        ...
        <div style={{ color: "var(--foreground-dim)", flexShrink: 0, marginTop: 2 }}>
